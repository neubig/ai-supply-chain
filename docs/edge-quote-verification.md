...
- [ ] <!-- edge-quote-verification key="b358d08d039cf78a" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-api-developed-by-org` / `manual:edge-example-api-developed-by-org`
  - Edge: `software:example-api --developed_by--> organization:example-org`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="71c5572447f6a08e" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-api-licensed-as-license` / `manual:edge-example-api-licensed-as-license`
  - Edge: `software:example-api --licensed_as--> license:example-license`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="76b816a09b8345e6" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-app-depends-on-runtime` / `manual:edge-example-app-depends-on-runtime`
  - Edge: `application:example-chat-app --depends_on--> software:example-runtime`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="6cad82cbb4a93808" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-app-developed-by-org` / `manual:edge-example-app-developed-by-org`
  - Edge: `application:example-chat-app --developed_by--> organization:example-org`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="9f3b099a26440765" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-app-licensed-as-license` / `manual:edge-example-app-licensed-as-license`
  - Edge: `application:example-chat-app --licensed_as--> license:example-license`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="345cef1d7156526d" quote_sha256="0aedbf4eb76cf9c720685baa265902b550dbf72975ee2c8e1c3720ecb2f23154" --> `edge:example-app-supports-model` / `manual:edge-example-app-supports-model`
  - Edge: `application:example-chat-app --supports--> model:example-chat-model`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "The site builds candidate downstream stacks from `application --supports--> model` edges, then follows reachable software, dataset, benchmark, infrastructure, hardware, sandboxing, and license dependencies. It scores each option by:"
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="407a5d9d2b5d372d" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-base-model-developed-by-org` / `manual:edge-example-base-model-developed-by-org`
  - Edge: `model:example-base-model --developed_by--> organization:example-org`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="83caa205b35162ff" quote_sha256="f20ab6a9ef6bae42187411ad5d143202709f2abbda2f9e063511f307ce8b6467" --> `edge:example-base-model-evaluated-on-benchmark` / `manual:edge-example-base-model-evaluated-on-benchmark`
  - Edge: `model:example-base-model --evaluated_on--> benchmark:example-benchmark`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "- `benchmark`: task scores such as MMLU, HumanEval, MTEB, WER, or image-generation benchmarks."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="3d448dd3a08d980c" quote_sha256="53c3b2ee13c8d0d9e1f4c59256e22b43e57cb72e9f19c7dc4311cdae0cd299e7" --> `edge:example-base-model-hosted-by-hub` / `manual:edge-example-base-model-hosted-by-hub`
  - Edge: `model:example-base-model --hosted_by--> infrastructure:example-hub`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "1. Official APIs such as GitHub and Hugging Face. 2. Official repository files, model cards, dataset cards, benchmark pages, and papers. 3. Package registries or release metadata. 4. Manual review or web search only when deterministic sources are not available."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="addda517b8b2c0e5" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-base-model-licensed-as-license` / `manual:edge-example-base-model-licensed-as-license`
  - Edge: `model:example-base-model --licensed_as--> license:example-license`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="101a732d0382bbcc" quote_sha256="8766546b24f0d10bce5d19e36fbe560c665d8965222abe9180aeaf138e6690cd" --> `edge:example-base-model-trained-with-runtime` / `manual:edge-example-base-model-trained-with-runtime`
  - Edge: `model:example-base-model --trained_with--> software:example-runtime`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "Top-10 layer coverage lives in `data/research/stack-layers.json` and is validated against graph node IDs. The current layers cover user-facing applications, foundation/chat models, coding models, image/media models, embedding/reranking models, speech/audio models, inference runtimes, training/fine-tuning frameworks, hardware accelerators, RAG/vector/data infrastructure, agent sandboxing, and evaluation tools/benchmarks."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="3507b80c379e63da" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-benchmark-developed-by-org` / `manual:edge-example-benchmark-developed-by-org`
  - Edge: `benchmark:example-benchmark --developed_by--> organization:example-org`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="8ae245ab68eb26a7" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-benchmark-licensed-as-license` / `manual:edge-example-benchmark-licensed-as-license`
  - Edge: `benchmark:example-benchmark --licensed_as--> license:example-license`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="0ff0ce5263e8a60b" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-benchmark-uses-data` / `manual:edge-example-benchmark-uses-data`
  - Edge: `benchmark:example-benchmark --uses_data--> dataset:example-pretraining-data`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="6970201d5df219ad" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-dataset-developed-by-org` / `manual:edge-example-dataset-developed-by-org`
  - Edge: `dataset:example-pretraining-data --developed_by--> organization:example-org`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="d3d6cf2d14b6f7ee" quote_sha256="53c3b2ee13c8d0d9e1f4c59256e22b43e57cb72e9f19c7dc4311cdae0cd299e7" --> `edge:example-dataset-hosted-by-hub` / `manual:edge-example-dataset-hosted-by-hub`
  - Edge: `dataset:example-pretraining-data --hosted_by--> infrastructure:example-hub`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "1. Official APIs such as GitHub and Hugging Face. 2. Official repository files, model cards, dataset cards, benchmark pages, and papers. 3. Package registries or release metadata. 4. Manual review or web search only when deterministic sources are not available."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="52b6f306be45bce2" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-dataset-licensed-as-license` / `manual:edge-example-dataset-licensed-as-license`
  - Edge: `dataset:example-pretraining-data --licensed_as--> license:example-license`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="82370de70485e500" quote_sha256="35669e8b4061e0ee50a0041634d37a94867434fd7096609e96dce554c3182251" --> `edge:example-model-derived-from-base-model` / `manual:edge-example-model-derived-from-base-model`
  - Edge: `model:example-chat-model --derived_from--> model:example-base-model`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "- `src/schema.ts`: Zod schema and inferred TypeScript types. - `src/lib/`: graph loading, stack ranking, and visualization logic. - `app/`: Next.js app deployable on Vercel. - `data/nodes/`: JSON node records separated by node kind. - `data/edges/`: JSON edge records separated by relationship family. - `examples/`: Minimal examples for each schema object and edge category. - `schema/`: Generated JSON Schema for the complete graph. - `visualizations/`: Generated graph artifacts. - `docs/risk-analysis.md`: Risk dimensions, source frameworks, and answerable questions."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="632be07f9b948f29" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-model-developed-by-org` / `manual:edge-example-model-developed-by-org`
  - Edge: `model:example-chat-model --developed_by--> organization:example-org`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="089b1b8d4d26caf9" quote_sha256="f20ab6a9ef6bae42187411ad5d143202709f2abbda2f9e063511f307ce8b6467" --> `edge:example-model-evaluated-on-benchmark` / `manual:edge-example-model-evaluated-on-benchmark`
  - Edge: `model:example-chat-model --evaluated_on--> benchmark:example-benchmark`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "- `benchmark`: task scores such as MMLU, HumanEval, MTEB, WER, or image-generation benchmarks."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="a6f904feaa11aa17" quote_sha256="53c3b2ee13c8d0d9e1f4c59256e22b43e57cb72e9f19c7dc4311cdae0cd299e7" --> `edge:example-model-hosted-by-hub` / `manual:edge-example-model-hosted-by-hub`
  - Edge: `model:example-chat-model --hosted_by--> infrastructure:example-hub`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "1. Official APIs such as GitHub and Hugging Face. 2. Official repository files, model cards, dataset cards, benchmark pages, and papers. 3. Package registries or release metadata. 4. Manual review or web search only when deterministic sources are not available."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="16b6f12998557abd" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-model-licensed-as-license` / `manual:edge-example-model-licensed-as-license`
  - Edge: `model:example-chat-model --licensed_as--> license:example-license`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="809138a8a0b715c0" quote_sha256="8766546b24f0d10bce5d19e36fbe560c665d8965222abe9180aeaf138e6690cd" --> `edge:example-model-trained-with-runtime` / `manual:edge-example-model-trained-with-runtime`
  - Edge: `model:example-chat-model --trained_with--> software:example-runtime`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "Top-10 layer coverage lives in `data/research/stack-layers.json` and is validated against graph node IDs. The current layers cover user-facing applications, foundation/chat models, coding models, image/media models, embedding/reranking models, speech/audio models, inference runtimes, training/fine-tuning frameworks, hardware accelerators, RAG/vector/data infrastructure, agent sandboxing, and evaluation tools/benchmarks."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="7f3883ebebfeff47" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-runtime-developed-by-org` / `manual:edge-example-runtime-developed-by-org`
  - Edge: `software:example-runtime --developed_by--> organization:example-org`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="3b401f10a46cdea9" quote_sha256="eb31d950d8db6e2806ecc40c0b8fcd0e38e2ecdefa37d635f787099a8b8ef880" --> `edge:example-runtime-implements-api` / `manual:edge-example-runtime-implements-api`
  - Edge: `software:example-runtime --implements--> software:example-api`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "- `examples/`: Minimal examples for each schema object and edge category."
  - Manual verification: quote directly supports the edge relationship.

- [ ] <!-- edge-quote-verification key="8dcf1f0afb81a983" quote_sha256="0ae29c1d33635124f4c4f28e6e1a13d4e85f4c6ebad13cc5112d32f6a4e07be6" --> `edge:example-runtime-licensed-as-license` / `manual:edge-example-runtime-licensed-as-license`
  - Edge: `software:example-runtime --licensed_as--> license:example-license`
  - Source URL: https://raw.githubusercontent.com/neubig/ai-supply-chain/main/README.md
  - Quote: "This repository models the AI supply chain as a typed TypeScript graph. Nodes are user-facing applications, models, datasets, software, benchmarks, organizations, infrastructure, and licenses. Edges represent supply-chain relationships such as `supports`, `depends_on`, `requires`, `trained_on`, `trained_with`, `evaluated_on`, `developed_by`, `hosted_by`, `licensed_as`, `runs_on`, `optimized_for`, `supports_hardware`, and `sandboxed_by`."
  - Manual verification: quote directly supports the edge relationship.
